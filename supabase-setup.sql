...
CREATE TABLE IF NOT EXISTS public.daily_logs (
  ...
  breakfast_protein numeric NOT NULL DEFAULT 0,
  breakfast_carbs numeric NOT NULL DEFAULT 0,
  breakfast_fat numeric NOT NULL DEFAULT 0,
  lunch_protein numeric NOT NULL DEFAULT 0,
  lunch_carbs numeric NOT NULL DEFAULT 0,
  lunch_fat numeric NOT NULL DEFAULT 0,
  snacks_protein numeric NOT NULL DEFAULT 0,
  snacks_carbs numeric NOT NULL DEFAULT 0,
  snacks_fat numeric NOT NULL DEFAULT 0,
  dinner_protein numeric NOT NULL DEFAULT 0,
  dinner_carbs numeric NOT NULL DEFAULT 0,
  dinner_fat numeric NOT NULL DEFAULT 0,
